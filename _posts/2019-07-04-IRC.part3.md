...
# Conclusion
There are still a lot of empty spaces. Knowing how to how to install third-party modules, is important. We will cover that in the next blog. In the making of this blog, I heavily relied on `#znc` on Freenode and [ZNC](www.wiki.znc.in). I highly recommend both the resources to anyone who uses ZNC.
